"""-------------------------------------------------------------------------------------------
Yousef Yassin, Youcef Ben Ali, Logan Norquay            January 24, 2019           Build 4.0.1
...
#matplotlib, pandas, pandas_datareader, yahoo_fin, 
...
class HomePage(tk.Frame):
    ...
    def __init__(self, master, controller):
        ...
        def NavAccess():
            ...
            #Creates 2 buttons (Stocks (Yousef Y.) and Accounts (Youcef B or Logan) to navigate to those
            #respective pages
